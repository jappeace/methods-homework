...
zero 	xpos 		firsty 		secondy		errbotstart		errbotend 		errtopstart			errtopend
0 		1           0         	1			0.1				0.2				0.1	               0.2
0 		2           1         	2			0.3				0.1             1.5               0.4
0 		3           2         	3.5			0.5				0.2             0.3               0.4
\end{filecontents*}
...
\addplot[color=white]
table[on layer=axis grid, x=xpos, y=firsty]{\dataTable};

\addplot[color=red] plot[on layer=axis lines,error bars/.cd, y dir=both, y explicit] 
table[x=xpos, y=zero, y error minus=errbotstart, y error plus=errbotend]{\dataTable};

\addplot[color=red] plot[on layer=axis lines,error bars/.cd, y dir=both, y explicit] 
table[x=xpos, y=secondy, y error minus=errtopstart, y error plus=errtopend]{\dataTable};
