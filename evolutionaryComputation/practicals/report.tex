...
\section{Execution}
%TODO:
% 1. Tournement selection is now implemented wrongly
%	* group(2) to select the first half off the parents
%	* randomly shuffle and group(2) again to select the second half
% 2. Mutation, should be trivial with help of the members factory, decide how
	% many bits will be mutated and then mutate those.
% 3. Offspring generation should create 2 instead of one.
% 4. Experiments
