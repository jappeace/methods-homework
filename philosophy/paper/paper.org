...
working on it.
He stated that developing the system just became to complex.
...
3. Secondly was a description of something which we today would call machine learning:
