...
\AxiomC{$\Gamma_1, \Gamma_2 \Rightarrow A, \Delta_1,\Delta_2$}
\RightLabel{LC}
\UnaryInfC{$\Gamma \Rightarrow A, \Delta_1,\Delta_2$}
\RightLabel{RC}
...
\AxiomC{$\Gamma_1, \Gamma_2, A \Rightarrow \Delta_1,\Delta_2$}
\RightLabel{LC}
\UnaryInfC{$\Gamma, A \Rightarrow \Delta_1,\Delta_2$}
\RightLabel{RC}
...
\UnaryInfC{$\Gamma \Rightarrow A, \Delta_1,\Delta_2$}
\RightLabel{LW}
\UnaryInfC{$\Gamma_1, \Gamma_2  \Rightarrow A, \Delta_1,\Delta_2$}
\end{prooftree}
\begin{prooftree}
...
\UnaryInfC{$\Gamma, A \Rightarrow \Delta_1,\Delta_2$}
\RightLabel{LW}
\UnaryInfC{$\Gamma_1, \Gamma_2, A \Rightarrow \Delta_1,\Delta_2$}
\end{prooftree}
