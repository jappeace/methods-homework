...
$}
\UnaryInfC{$
	\langle x: (B / D) / ((A/ C)\setminus C) \rangle
	\vdash
	x: (B / D) / ((A/ C)\setminus C)
$}
\AxiomC{}
\RightLabel{$
	Ax
...
$}
\UnaryInfC{$
	\langle x: (C \multimap C) \multimap B \multimap D \rangle
	\vdash
	x: (C \multimap C) \multimap B \multimap D
$}
\AxiomC{}
\RightLabel{$
	Ax
