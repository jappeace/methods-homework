...
In het begin van de week heb ik de implementatie en conclusie hoofdstukken gemaakt.
Daarna heb ik al uw aanmerking heb verbeterd:
+ Spelfouten nagelopen (en een spellchecker over het hele document gedaan).
+ Introductie fouten verbeterd.
+ Social practice
  + Plan patterns verbetert waar nodig
...
commentaar werd bedoeld (of er nog meer aan gebeurd moest worden).
...
misschien 200 regels Java code in totaal is exclusief commentaar
