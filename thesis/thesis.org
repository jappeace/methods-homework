...
* In conclusion
\drafting
In this work we have shown a possible interpertation of
carl jung's theory of types (see section [[Personality types]]).
We combined it with the idea of personality as a process, 
where personality is encoded in different strategies,
rather than objects.
