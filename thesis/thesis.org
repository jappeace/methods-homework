...
or in certain cases very thight.
...
What we do is to combine the units of processing into a non commutative chain.
This chain will then receive the information, which each unit can modify.
...
*** Symbol graph
 ...
 for each actor there will be a possible utterance $u$.
...
#+CAPTION: Activity diagram of a server game construction
#+LABEL: fig:initjung
#+RESULTS[ae2a671ca00fca46fe02e4d96b7806774274ee3d]: fig:initjung
...
This will allow the orignal drool rules to still execute.
...
[[https://github.com/jappeace/gaia]].
...
Alternative implmenetations could also be developed for the irrational functions,
we leave speculation about these as an excersize to the reader.
