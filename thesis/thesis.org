...
order, this order determines the personality.
Then what we set out to do in the rest of the chapter is how to model this
into /types/.
On the one hand for the functions, but on the other hand for the data used.
...
\todo{Should I move this to background? Perhaps I can place it under software engeneering}
\toReview
