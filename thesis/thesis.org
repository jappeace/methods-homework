...
**** PPSDQ
 ...
 Also note that the amount of available options presented in these kind of
 ...
 five options you can go less extreme but still in a direction.
...
#+NAME: tab:word-pair-example
 ...
 \todo{How do you select here?}
 \todo{In the real test I think they used 5 point}
 \todo[inline]{How are these word pairs obtained?}
 \todo[inline]{Explain point bias, 123, 12345}
