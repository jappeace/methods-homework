...
\todo[inline]{What is personlaity? (wiki ref can be used even, but I think its in the handbook)}
\todo{for example: Personality identifiers that can be used with reasonable consistency to predict behavior}

\todo[inline]{What do we want form personality theories? We just want a model to implement.}
\todo[inline]{There is no "best" personality theory, its just something to argue about}
\todo[inline]{Personality is just an approach, there doesn't exist a best model}
...
*** The big five
 ...
 analyses cite:varymaxrotanonalprogram]. \todo{What data did they use? What did they look at? what did they do?}
 ...
 \cleared
 The big five as in the OCEAN definition \todo{Isn't this interpretation?}
 ...
 Lets say you have a score of 0.8 for Neuroticism, \todo[inline]{How can thesescores be used? Is there a standard intrepertation from psycology? Or are there examples of how much work it is to do this yourself?}
...
\todo[inline]{extend the examples more}
 ...
 and therefore be more like a scientist, \todo{Why is this the case?}
 \todo{This i too unclear because it doesn't it for biology scientists for example}
