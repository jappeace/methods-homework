...
#+RESULTS[51c9e95a779d463b530be5129d1f6527cc49d302]: fig:dep:connections
[[file:img/uml/dep:connections.png]]

\drafting
However such a representation is too simplistic for various reasons.
We will discuss this in the next section why this is the case,
but once this step is made away from implicit connections to explicit
connections,
it turns out that the connections are by far the most complex piece in dialogue
modelling.
