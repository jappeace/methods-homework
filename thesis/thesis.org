...
** N-agent extension
\drafting
because in architecture we would like to see n-agent support we should also
describe how this could work in dialogue tree deliberation and in utterence
processing.
\todo[inline]{describe a function that does this}
\todo[inline]{also a method to figure out which agent an utterence was directed at}
