...
\toReview
From this we used the MBTI idea that these small processing units are in an
order, this order determines the eventual personality.
...
#+RESULTS[65aeceb37d1b58ff03765f9e305358f4f5427bb9]: fig:dialoguetree
