...
#+LATEX_HEADER: \newcommand{\newlycleared}{\todo[noline, backgroundcolor=white, bordercolor=red]{Cleared*}}
...
** The serious game
 ...
 \drafting
 Now there is a difference between the architecture in the published papers and
 ...
 being only used for processing and not deliberation
 ...
 work because its more relevant.
...
**** Source tree
    ...
    The protocol is tracked in the respective client and server folders and
    named dto.
...
**** Protocol
    ...
    A typical happy path scenario is listed in figure [[fig:sequence]]
