...
\newpage
*** Initialization
\todo[inline]{We should keep this section more focused, IDK why I start talking here about connections etc, we should just talk about initialization}
\newlyCleared
...
A symbol has connections to other symbols, which should be sensible responses. \todo{wut? Discuss this here?? Seems strange}
...
#+BEGIN_SRC plantuml :cache yes :file img/uml/initjung.png :exports results
  ...
  :Parse YML files;
  :Construct initial believes;
  :Construct pattern DBs;
  |#CCDDDD|Engine|
...
#+CAPTION: Activity diagram of a server game construction
#+LABEL: fig:initjung
#+RESULTS[763266e1aab7e13801dca3cbcd932bf353cc39be]: fig:initjung
