...
\todo[inline]{Depth first vs breath first}
...
\todo[inline]{So what about the difference between $S_e$ and $S_i$ is that $S_e$ does breath first whereas $S_i$ does depth first}

*** TODO how to use this in dialogue

**  TODO is this interpretation effective?
\todo[inline]{Does INTJ and ENTJ become different? How about INTJ and INTP?}
