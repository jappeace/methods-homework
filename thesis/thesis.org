...
We want to also do this but using Jungian function attitudes rather than
the measured MBTI dimensions directly.
...
#+BEGIN_SRC plantuml :file img/uml/faprocessing.png :exports results
  start
