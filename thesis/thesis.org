...
whereas $F_i$ could use sacrificing play cite:stimpson2003learning.
...
Therefore $B = (m, h, [m], [D], G)$
\todo{lacks satisficing and fictitious play values}

#+CAPTION: $f_a$ and their required data
