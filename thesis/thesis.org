...
These therefore aren't he same as the personalities discussed in section
[[personality theories]],
but rather they indicate how the agent deals with emotion.
This Fatima architecture is an extension upon BDI cite:lim2008improving.
...
\clearpage
* Related work
\ask{Can't I just merge this chapter into background?}
<<Related work>>
\newlyCleared
