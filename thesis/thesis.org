...
** Personality types
*** TODO check math of campos/dignum and compare to own
...
The PPSDQ is measuring the same thing as MBTI 
...
** The best personality framework for CS
...
cooralation with the big five cite:arnau1997measurement.
...
Then to decide which function attitude to use some kind of mixed strategy
has to be used.
...
Therefore we can say the SL-TDI is more difficult to implement than PPSDQ but
also more realistic.
