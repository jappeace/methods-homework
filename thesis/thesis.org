...
To measure performance a production rule engine was used called drools,
the social practice of a doctor consult was used in this particular instance,
for other scenarios other social practices could be used.
...
disadvantages in section [[personality theories]].
Then we'll discuss AI literature in section [[Artificial intelligence literature]].
...
wherein section
[[A type signature approach]] is about making a theoretical data structure to do
this, and section [[Mapping to process]] is about discusing what the jungian
