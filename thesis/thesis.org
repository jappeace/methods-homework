...
orientated programming langauges,
drools can be seen as a more low level variant,
where things such as goals and ontology are not predefined.
This is called a production rule system, which is based around the RETE
