...
\todo{except we do way more in this chapter, such as 1 limiting the scope by using category thoery/haskell types, 2 going from text to game thoeretic actions}
...
*** From strings to playable actions
\todo[inline]{Perhaps I should move this to implementation? Or split this up into an abstrat and an xml representation?}
...
is of a reaction.
So the modification would include:
...
\drafting
Now we lost the responsive nature of the chatbot, rather than saying how to
reply directly to certain kind of responses we just say what they mean in this
social context.
...
** TODO Convert all of AIML to something more terse
