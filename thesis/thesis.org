#+TITLE: Composeable personality parts
...
in which $\pi_t$ with $\pi_t \subseteq \Pi$ denotes the perception information of an
agent at time $t$.
...
| $p$           | $p \in \mathcal{P}$              | A perlocutionary speech acts                  |                                          |
