...
#+END_SRC
#+CAPTION: Dbclass diagram of the server, where kie is the engine that handles the drools
#+LABEL: fig:dbclass
#+RESULTS[21d5587cd72af0f635dbf8d8579dd2c7fa664792]: fig:dbclass
...
#+END_SRC
#+CAPTION: Jungclass diagram of the server, where kie is the engine that handles the drools
#+LABEL: fig:jungclass
#+RESULTS[0a2997f9591ea5ff0b150aa0002e07d96e9be563]: fig:jungclass
[[file:img/uml/jungclass.png]]

*** Initialization
\todo[inline]{Add sequence diagram and discuss how its different from the previous one}
 \drafting
 + init game
 + read yml
