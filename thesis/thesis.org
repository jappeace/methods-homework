...
to is put isnide the node. Non intrusive representation is where edges are
...
\drafting
There are argumetns for both representation, an intrusive graph
reprsentation is more easy to understand for humans, however a non intrusive
reprsentation is more elegant and can handle things such as backward chainging
...
is impatiant and can look at this connection and see what this path results in.
