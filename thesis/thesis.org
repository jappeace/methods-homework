...
*** Operation
 ...
 #+RESULTS[fcf9bac625ae1eadb2adefadc54c87c6381fd7f8]: fig:insert_meaning
...
+ Shouldn't I ensure the personality goes back and forth, right now it just goes
  ...
  + To test this I think we create a personality in the believes and apply the
    dialgoure tree for one pass, then once going back we check on each level if
    the right level is modified. (going deep should behave correct right now).
** Tooling stuff
