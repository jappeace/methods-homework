...
<<Jungian types>>
 ...
 \todo[inline]{extend the examples more}
 \drafting
...
**** MBTI
 ...
 \todo[inline]{Change these critisims to be more out of the references rather than that we agree with them}
 \cleared
 ...
 however concluded that this was not the case and a continues scale \todo{ Why is this a critique, dignum got a scale like result? we should explain what's happenning here}
 is required
 ...
 \todo[inline]{Is there any research showing a year consitency? Perhaps users would change their outcome becuase they didn't like the results and changed their input cause they remember?}
...
\drafting
test uml
#+BEGIN_SRC plantuml :file img/sequence1.png :exports results
  ' this is a comment
