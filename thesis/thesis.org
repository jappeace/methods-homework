...
with dynamic social envirnoments autonimously.

\toReview
We can consider the Fatima architecture  cite:dias2005feeling
as an intelligent virtual agent archticture.
In this OCC was used to define and track emotions in their respective agents.
...
These don't follow the thoery discussed in section [[personality theories]].
...
lead in future work lead to an agent that can chat much more realistically than
