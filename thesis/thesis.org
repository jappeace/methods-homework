...
Therefore a general "communicate!" game was developed. \dignum{Communicate was made for medicine students}
...
to that of a doctor's appointment social practices were used. \dignum{SP for doctor consult was used in this scenario. But not as a restriction. For other scnearios other SP's can be used}
...
\todo[inline]{Describe the structure of this document}
** Related work
\dignum{Needs to be moved to behind the background work}
\ask{Wait so in the background chapter? Or behind?}
\todo{I guess we just move it into the background chapter at the end}
<<Related work>>
\cleared
...
*** The big five
 ...
 others. Cattell used a\todo{this was marked??} rating scheme,
...
\dignum{This is no background and doesn't belong here. It is part of the experiment}
<<Personality influence case study>>
...
\toReview
In another paper cite:penning2007boosting, multilogue is already possible.
However this design is /drastically/ different from the one we presented.
They tried to improve input understanding,
...
star tags.
They also seemed to have problem with context, which we partly solved with
scenes.
...
I did this of course not on my own.
Many thanks to my teacher Dr. F. Dignum, for helping me ask the right questions,
keeping me focused, and with the form of the thesis.
...
#  LocalWords:  Rao Bratman's Grice's anamnesi ENFP ISTP toc se
