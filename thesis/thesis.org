...
\toReview
After the personality was implemented, a request came to bring the new chat
bot up to feature parity with the ALICE bot. 
...
#+BEGIN_SRC plantuml :cache yes :file img/uml/templateclass.png :exports results
  ...
  Utterance --* Inforamtive
  Utterance --* CapturedMatchDB
#+END_SRC
#+CAPTION: Before and template class diagram
#+LABEL: fig:templateclass
#+RESULTS[b43af2dda61014860af6f089ab3b1740705c4a92]: fig:templateclass
[[file:img/uml/templateclass.png]]

\drafting
We can see from figure [[fig:templateclass]] th
