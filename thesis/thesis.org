...
\toReview
In this chapter we will look at some of the AI based literature.
...
try to come up with a prototype that models a pure function for all the
function attitudes.
...
following pure function prototype 
...
replies at time $t$. This produces the prototype:
\[ B_t \to t \to M_t \overset{f_a}{\to} (B_{t+1}, R_{t+1}) \]

\drafting
Now we should note that this heavily constrains our agent.
...
prototype that can use these functions for the text replies.
