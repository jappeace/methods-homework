...
A fact can be considered a value.
The current program uses globals as comminucation with external libraries
...
stop
#+END_SRC
#+CAPTION: Activity diagram of servergame construction
...
\toReview
     In this case if a user utteres the sentence: "why are you here", the bot
