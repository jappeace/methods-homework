...
\todo[inline]{Re add source link, perhaps in building appendix?}
** Abstract                                                          
:PROPERTIES:
:UNNUMBERED: t
:END:
...
#+NAME: tab:word-pair-example
 ...
 some math is required. Our subject in our example is $70\%$ of the time \todo{this is not correct. If the score for introvertion is 70, it means the strength of this influence or tendency is 70 on a scale of 100. It has not much to do with frequencies or probabilities. I.e. choices can be very consistent  but behaviour in general less extreme introvert.}
...
transformation of the utility function and transformations of probabilities
of state.
...
that it no longer is AIML. \todo{explain here already the basic reasons.}
...
implement these as behavior in section [[Rational and irrational]]. \todo{How about 4.5?}
...
\todo{Do we mention somewhere that $a \to a$ doesn't mean the value is the same?}
...
\todo[inline]{Seriously get rid of time T, its completely useless and makes things even more complex}
\doubleCleared
Let $\mathcal{B}$ denote the set of all \todo{Are we going to do at time T? I think it is confusing to do that on types}
...
Where it will block until a time $t$ has passed or a new perception $\pi$ comes in from
the environment.]
...
#+RESULTS[63c13339c5b78776640fe21523eade9c064e7e97]: fig:droolclass
...
#+LABEL: fig:jungclass
#+RESULTS[9637bf42245bada51e276c137daa1db820e43718]: fig:jungclass
...
\todo{Give a description of these issues here. That is exactly what is interesting!}
