...
#+BEGIN_SRC plantuml :cache yes :file img/uml/sp-activity.tex :cmdline -tlatex:nopreamble :exports none
[*] --> Greeting
...
#+RESULTS[b4df1201e0762c4d97c613c3385c786f94799dea]: fig:sp-activity
[[file:img/uml/sp-activity.tex]]

#+CAPTION: Plan pattern example 
#+LABEL: fig:sp-activity
#+INCLUDE: "./img/uml/sp-activity.tex" :only-contents t 
